...
//         cout << "Enter max for process " << i + 1 << ": ";
//         cin >> max_[i].a >> max_[i].b >> max_[i].c;
//     }

//     cout << "Enter available memory: " << endl;
//     cin >> avail.a >> avail.b >> avail.c;

//     for (int i = 0; i < 5; i++) {
//         need_[i].a = max_[i].a - allocation_[i].a;
//         need_[i].b = max_[i].b - allocation_[i].b;
//         need_[i].c = max_[i].c - allocation_[i].c;
//     }
...
//     while (done < 5) {
//         if (need_[i].a <= avail.a && need_[i].b <= avail.b && need_[i].c <= avail.c) {
//             avail.a += allocation_[i].a;
//             avail.b += allocation_[i].b;
//             avail.c += allocation_[i].c;
//             done++;
//             cout << "Process " << i + 1 << " is executed" << endl;
//         } else {
//             cout << "Process " << i + 1 << " is not executed" << endl;
//         }
